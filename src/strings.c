...
const u8 gText_TurnOff[] = _("NAQASUA'TOQ");
...
const u8 gText_RedShard[] = _("MEKWE'K SHARD");
const u8 gText_YellowShard[] = _("WATAPTEK SHARD");
const u8 gText_BlueShard[] = _("MUSQUNAMU'K SHARD");
const u8 gText_GreenShard[] = _("ESKIT SHARD");
